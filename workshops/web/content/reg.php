...
Click <a href="<?php echo "../../dashboard.php"; ?>">here</a> to register for Workshop.
 <br/><br>
You should register for workshops only after payment is made. No registrations will be confirmed if payment details are not provided. If you are unable to pay the full amount now, you can pay 50% of the total amount and make remaining payment one day before the date of workshop. In case you fail to make the remaining payment, your registration will be canceled and no reimbursement will be given.
...
<br><br>
4.SBI Collect<br><br>
Click <a href="<?php echo "../../pdf/workshops/5.Get Plugdin - Website development using Jquery.pdf"; ?>" target="_blank">here</a> to refer how to pay through SBI Collect<br/>
</p>
