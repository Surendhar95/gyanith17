...
if(isset($_POST['submittmwrk1'])){
     ...
     //getting id
      ...
      $result=$stmt2->execute(array(':tid'=>$tid,':gid'=>$g_id));
           ...
           $sql="insert into workshops(g_id,t_id1) values (:gid,:tid)";
             $stmt3 = $db->prepare($sql);
      ...
      //validate gid for team membe
        ...
        if(!empty($_POST['wemate11'])){
          $emate1=$_POST['wemate11'];
          if($emate1!=$g_id){
       ...
       if(!empty($_POST['wemate12'])){
          $emate2=$_POST['wemate12'];
           if($emate2!=$g_id){
         ...
         if(!empty($_POST['wemate13'])){
          $emate3=$_POST['wemate13'];
           if($emate3!=$g_id){
         ...
         if(!empty($_POST['wemate14'])){
          $emate4=$_POST['wemate14'];
           if($emate4!=$g_id){
        ...
        if(!empty($_POST['wemate15'])){
          $emate5=$_POST['wemate15'];
           if($emate5!=$g_id){
        ...
        if(!empty($_POST['wemate16'])){
          $emate6=$_POST['wemate16'];
           if($emate6!=$g_id){
