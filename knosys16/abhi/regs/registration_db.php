...
<body><!--style='background-image:url("svg/register_bg.svg")'>  -->
  ...
  <br><br> <br>
    <div class="signin-form">
    	<div class="container" style="background-color:#0088bb;">
            <div class="row" style='position:relative;top:20px'>
                <div class='col-sm-10 col-md-10 col-lg-10'>
                    <form class="form-signin" method="post" id="register-form" action="">
                        </br>
                         <div id="error">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" style='width:300px;float:left' placeholder="" name="first_name" id="first_name" />
                        </div>
                        </br></br>
                        </br>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" style='width:300px;float:left' placeholder="" name="second_name" id="second_name" />
                         </div>
                         </br></br>
                        </br>
                        <div class="form-group">
