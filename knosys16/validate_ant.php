...
$db->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_WARNING);
	if(isset($_POST['reg'])){
		...
		else 
		{
			...
			$body='<p>Thank you for registering for Antagon<br>
The event will be conducted on 20th March 2016 from 10pm – 1 pm at NIT Puducherry.<br>
...
For any queries regarding the event please post a mail to antagon@knosys.in<br>
...
$body1='<p>Thank you for registering for Antagon<br>
The event will be conducted on 20th March 2016 from 10pm – 1 pm at NIT Puducherry.<br>
We would love to have your presence at the venue on 19th and 20th of March.<br>
Kindly carry your college Id card with you.<br>
For any queries regarding the event please post a mail to antagon@knosys.in<br>
