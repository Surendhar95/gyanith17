...
<div class="signin-form">
	...
	<div class="container">
       ...
       <form class="form-signin" method="post" id="reg_btn">
    ...
    <div style='position:relative;right:140px' class='text-danger'><h5>Login to register for the Workshop.</h5></div>

  
       <div class="form-group" style='position:relative;left:170px'>
    <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" class="btn btn-default disabled" style='float : left;disabled:disabled' name="reg" id="btn-submit">
