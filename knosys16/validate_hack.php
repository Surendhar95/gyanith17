...
$mail->From = 'kackathon@knosys.in';
$mail->FromName = 'Knosys 16';
$mail->addAddress($email);                 // Add a recipient

$mail->WordWrap = 50;                                 // Set word wrap to 50 characters

$mail->Subject = 'Hackathon Team';
$mail->Body    = $body;
$mail->AltBody = $body1;
...
$db->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_WARNING);
	if(isset($_POST['reg'])){
			...
			$stmt=$db->prepare('SELECT username FROM hackathon WHERE Kid=:kid');
		...
		{
			$stmt1=$db->prepare('INSERT INTO hackathon VALUES(:kid,:username)');
			$stmt1->execute(array(':kid'=>$_SESSION['kid'],':username'=>$_SESSION['username']));
			$body='<p>Thank you for registering for Hackathon<br>
The event will be conducted on 20th March 2016 from 3pm to 5 pm at NIT Puducherry.<br>
...
For any queries regarding the event please post a mail to hackathon@knosys.in<br>
For further details about event and accommodation visit www.knosys.in<br>
Hope you’ll enjoy participating<br>
Regards<br>
Event coordinator.</p>
';
$body1='<p>Thank you for registering for Hackathon<br>
The event will be conducted on 20th March 2016 from 3pm to 5 pm at NIT Puducherry.<br>
We would love to have your presence at the venue on 19th and 20th of March.<br>
Kindly carry your college Id card with you.<br>
For any queries regarding the event please post a mail to hackathon@knosys.in<br>
