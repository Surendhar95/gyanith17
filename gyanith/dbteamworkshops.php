...
if(isset($_POST['submittmwrk'])){
     //insert team name in wrkteam table and update tid in workshops table
      ...
      echo 'success '.$tnm;
        ...
        //echo 'Your team member '.$emt1.'has not registered with any workshops';
   ...
   $stmt3->execute(array(':gid'=>$emt1,':tid'=>$tid));
      ...
      echo 'success '.$tnm;
       ...
       // echo 'Your team member '.$emt2.' has not registered with any worksops';
       $sql="insert into workshops(g_id,t_id) values (:gid,:tid)";
          $stmt3 = $db->prepare($sql);
     ...
     echo 'success '.$tnm;
       ...
       // echo 'Your team member '.$emt3.'has not registered with any workshops';
       $sql="insert into workshops(g_id,t_id) values (:gid,:tid)";
          $stmt3 = $db->prepare($sql);
