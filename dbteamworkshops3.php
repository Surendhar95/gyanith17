...
if(isset($_POST['submittmwrk3'])){
     ...
     //update in workshops table
      ...
      $result=$stmt2->execute(array(':tid'=>$tid,':gid'=>$g_id));
           ...
           $sql="insert into workshops(g_id,t_id3) values (:gid,:tid)";
             $stmt3 = $db->prepare($sql);
      ...
      //validate gid for team membe
        ...
        $stmt1 = $db->prepare($sql);
         if(!empty($_POST['wemate31'])){
          $emate1=$_POST['wemate31'];
          if($emate1!=$g_id){
         ...
         if(!empty($_POST['wemate32'])){
          $emate2=$_POST['wemate32'];
           if($emate2!=$g_id){
        ...
        if(!empty($_POST['wemate33'])){
          $emate3=$_POST['wemate33'];
           if($emate3!=$g_id){
        ...
        if(!empty($_POST['wemate34'])){
          $emate4=$_POST['wemate34'];
           if($emate4!=$g_id){
        ...
        if(!empty($_POST['wemate35'])){
          $emate5=$_POST['wemate35'];
           if($emate5!=$g_id){
        ...
        if(!empty($_POST['wemate36'])){
          $emate6=$_POST['wemate36'];
           if($emate6!=$g_id){
